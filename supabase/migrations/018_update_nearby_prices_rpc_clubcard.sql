-- 018: Update nearby_prices RPC to include clubcard pricing
-- This replaces the existing nearby_prices function with one that returns
-- clubcard_price, has_clubcard_pricing, and per_can_price columns
...
AS $$
  SELECT
    ...
    p.clubcard_price,
    CASE
      WHEN s.retailer = 'tesco' AND p.clubcard_price IS NOT NULL THEN true
      ELSE false
    END AS has_clubcard_pricing,
